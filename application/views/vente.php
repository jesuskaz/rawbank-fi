														...
														<tr>
															...
															<td>
																<?php
																	if($op["status"] == 1)
																	{
																		echo "<font color='green'><b>".' Versé '."</b></font>";
																	}
																	else
																	{
																		echo "<font color='green'><b>".' En cours '."</b></font>";
																	}
																?>
															</td>
															<td><a href="<?= site_url('index/bonus/').$op["numero_compte"].'/'.$op["iddevise"]?>">Detail Bonus</a></td>
														</tr>
													<?php
													}
													?>
	...
	<script>
		$(function() {
			$('form').submit(function(e) 
			{
				...
				$.post('<?= site_url('ajax/vente') ?>', form.serialize(), function(log) {
					log = JSON.parse(log);
